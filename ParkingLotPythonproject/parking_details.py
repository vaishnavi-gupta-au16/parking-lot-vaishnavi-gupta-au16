...
class ParkingLot:
    ...
    def free(self, slot_to_be_freed):
        ...
        if found:
            ...
            car_to_free = self.slot_car_mapping[slot_to_be_freed]
            self.color_registration_mapping[car_to_free.color].remove(found)
    ...
    def park(self, car):
        ...
        if slot_no is None:
            print("Sorry, All lots are Occupied")
            return
